...
const ANY_DEBT = [
  ...
  "client/src/components/knowledge/ArtifactEditor.tsx",
  "client/src/components/knowledge/RoadmapTab.tsx",
  ...
  "server/src/routes/roadmap.integration.test.ts",
  "server/src/routes/roadmap.ts",
